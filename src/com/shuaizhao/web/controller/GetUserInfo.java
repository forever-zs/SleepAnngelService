...
public class GetUserInfo extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UserDetailInfo userDetailInfo=us.findUserDetailInfoByPhoneNum(phone_UUID.getmPhoneNum());
		Gson gson=new Gson();
		out.write(gson.toJson(userDetailInfo));
		System.out.println(gson.toJson(userDetailInfo));
		out.close();
	}
